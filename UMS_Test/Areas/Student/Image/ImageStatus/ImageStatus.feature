...
Scenario: Check Image Status
	...
	And Select Organization "<Organization>" ImgStat
	And Select Program "<Program>" ImgStat
	And Select Session "<Session>" ImgStat
	And Select Image Status "<ImageStatus>" ImgStat
	And Select Courses "<Course>"
	And Select Gender "<Gender>"
	And Select Version "<Version>"
	And Select Branch "<Branch>" ImgStat
